...
class ADI(torch.nn.Module):
    ...
    def __init__(self, user_features, item_features, neg_item_feature, user_params):
        ...
        for m in [self.shared_weight, self.slot1_weight, self.slot2_weight, self.slot3_weight, self.se_weight1, self.se_weight2, self.se_weight3]:
    ...
    def user_tower(self, x):
        ...
        input_user = input_user.reshape(b, -1)

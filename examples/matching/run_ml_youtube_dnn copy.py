...
def get_movielens_data(data_path, load_cache=False):
    ...
    np.save("examples/ranking/data/ali-ccp/saved/raw_id_maps.npy", np.array((user_map, item_map), dtype=object))

    user_profile = data[["101", "109_14", "110_14", "127_14", "150_14","121","122","124","125","126","127","128","129","301"]].drop_duplicates('101')
    ...
    if load_cache:  #if you have run this script before and saved the preprocessed data
        x_train, y_train, x_test = np.load("examples/ranking/data/ali-ccp/saved/data_cache.npy", allow_pickle=True)
    else:
        ...
        np.save("examples/ranking/data/ali-ccp/saved/data_cache.npy", np.array((x_train, y_train, x_test), dtype=object))

    user_cols = ["101", "109_14", "110_14", "127_14", "150_14","121","122","124","125","126","127","128","129","301"]

    user_features = [SparseFeature(name, vocab_size=feature_max_idx[name], embed_dim=16) for name in user_cols]

    item_features = [SparseFeature('205', vocab_size=feature_max_idx['205'], embed_dim=16)]
    neg_item_feature = [
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default="examples/ranking/data/ali-ccp/ali_ccp_train_sample.csv")
